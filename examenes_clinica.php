<?php
 ...
 require_once('modals/edit_orden.php');
  require_once('modals/nueva_orden_clinicas.php');
?>
<style type="text/css">
  .dataTables_filter {
...
<button type="button" class="btn btn-md bg-primary agregar_oden_paciente" id="" onClick="clear_inputs_order('check_box');" data-toggle="modal" data-target="#nueva_orden_clinic" data-backdrop="static" data-keyboard="false" style="margin-left: 5px"><i class="fas fa-file-medical"></i> Nueva Orden</button>
