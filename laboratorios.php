...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="estilos.css">
        <style>          
           body{
    background-image: -moz-linear-gradient(top, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("images/banner.jpg");
    background-image: -webkit-linear-gradient(top, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("images/banner.jpg");
    background-image: -ms-linear-gradient(top, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("images/banner.jpg");
    background-image: linear-gradient(top, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("images/banner.jpg");
...
<!--=============PENDIENTE=============-->
	...
	<div class="row" style="margin-top:200px;"><!--INICIO ROW1-->
		<div class="col-sm-2"></div>

			<div class="col-sm-2" style="background-color:rgba(226,226,226,0.3);border-radius:10px; max-width:100%">
			     <a href="ordenes_metro.php"><img src="images/metro.png" alt="logoAvPlus" height="165" style="width: 100%; text-align: center !important;  margin-top:10px;max-height: 140px;"></a>
			</div>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<div class="col-sm-2" style="background-color:rgba(226,226,226,0.3);border-radius:10px; max-width:100%">
			    <a href="ordenes_sta.php"><img src="images/santaana.png" alt="logoAvPlus" height="165" style="width: 100%; text-align: center !important; margin-top:10px;max-height: 140px;"></a>
			</div>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

			<div class="col-sm-2" style="background-color:rgba(226,226,226,0.3);border-radius:10px; max-width:100%">
		    <a href="ordenes_empresarial.php"><img src="images/empresarial.png" alt="logoAvPlus" height="165" style="width: 100%; text-align: center !important; margin-top:10px;max-height: 140px;"></a>
			</div>
