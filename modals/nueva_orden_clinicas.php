...
<div class="modal fade" role="dialog" id="nueva_orden_clinicas">
  <div class="modal-dialog modal-lg" id="new_order_tam">

    <div class="modal-content">
     <div class="modal-header" id="head" style="justify-content:space-between">
       <span><i class="fas fa-plus-square"></i> CREAR NUEVA ORDEN DE EXAMENES</span>
        <button type="button" class="close" data-dismiss="modal" style="color:white">&times;</button>
     </div>
<section style="margin:15px">

    <div class="form-group col-md-6">
      <span style="font-size:18px"><strong>Orden #&nbsp;</strong></span><strong><span style="font-size:30px" id="correlativo_de_orden_clinica"></span></strong><br>
    </div>
  <div class="form-row">
    <div class="form-group col-md-8">
      <label for="inputEmail4">Nombre de paciente</label>
      <input type="text" class="form-control input-dark" id="nombre_orden_empleado" readonly>
    </div>

    <div class="form-group col-md-4">
      <label for="inputEmail4">Empresa</label>
      <input type="text" class="form-control input-dark" id="nom_empresa_orden" readonly>
    </div>
...
<input type="hidden" id="fecha_orden_clinica" value="<?php echo $hoy;?>">
<input type="hidden" id="id_paciente_orden_clinica">
<input type="hidden" id="tipo_orden" value="clinica">
<button class="btn btn-dark btn-block" style="border-radius:0px" onClick="agregarOrdenClinica();"><i class="fas fa-save"></i> Crear Orden</button>
</section>
    </div>
  </div>
</div>
