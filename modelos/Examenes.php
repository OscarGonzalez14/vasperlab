...
$conectar= parent::conexion();         
$sql= "select p.cod_emp,p.nombre,p.empresa,d.examen,d.numero_orden,d.categoria,p.empresa,p.departamento,d.fecha,d.estado,p.id_paciente from pacientes_o as p inner join detalle_item_orden as d on d.id_paciente=p.id_paciente where d.id_paciente=? and d.numero_orden=? group by d.categoria;";
$sql=$conectar->prepare($sql);
$sql->bindValue(1,$id_paciente);
$sql->bindValue(2,$numero_orden);
$sql->execute();
