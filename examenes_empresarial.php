...
<div style="margin: 25px">
    <h5 align="center"><strong>DETALLE DE EXAMENES&nbsp;-&nbsp; <span>ORDEN:&nbsp;</span><span style="color:blue"><?php echo $n_orden;?></span></strong></h5>
	<table class="table-hover table-bordered" id="data_examenes_empresarial" width="100%" data-order='[[ 0, "desc" ]]'>
