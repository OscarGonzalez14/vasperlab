...
switch($_GET["op"]){
  ...
  foreach($datos as $row)
  {
    ...
    $sub_array[] = '<button type="button" class="btn btn-light" onClick="eliminar_paciente('.$row["id_paciente"].');"><i class="fa fa-trash" aria-hidden="true" style="color:red"></i></button>';                                 
    $data[] = $sub_array;
  }
...
case "eliminar_paciente":
  ...
  $datos=$paciente->valida_orden_paciente($_POST["id_paciente"]);
