...
?>
  ...
  <div class="autocomplete" style="width:300px;">
    <input id="aspecto" type="text" name="myCountry" placeholder="Country">

    <input id="orina" type="text" name="myCountry" placeholder="Orina">
  </div>
  <input type="submit">
...
var orina = ["Leve","Leve Turbio"];
/*initiate the autocomplete function on the "myInput" element, and pass along the countries array as possible autocomplete values:*/
autocomplete(document.getElementById("aspecto"), countries);
autocomplete(document.getElementById("orina"), orina);
