<div style="margin-top: 2px;">
	<table class="table2" width="100%">
		<tr>
			<td colspan="100" style="color:black;font-size:12px;font-family: Helvetica, Arial, sans-serif;width:100%"><strong>Paciente:<strong> <?php echo ucwords(strtolower($paciente));?>&nbsp;&nbsp;&nbsp;&nbsp;<b>Cod. empleado:</b> <?php echo $cod_emp;?>&nbsp;&nbsp;&nbsp;&nbsp;<b>Edad:</b> <?php echo $edad. " años";?></td>
		</tr>
    <tr>
    <td colspan="100" style="color:black;font-size:12px;font-family: Helvetica, Arial, sans-serif;width:100%;padding: 5px"><strong>Muestra: <strong> Sangre</td>
    </tr>
		<tr>
