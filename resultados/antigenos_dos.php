...
<?php for($i=0;$i<sizeof($datos_antigenos);$i++){ ?>
            ...
            <div id="watermark">
             <img src="images/vasperoficial.jpg" width="700" height="300"/>
                ...
                <tr>
                    <td colspan="40" style="border-left:0px;width: 40%;/*font-family: Courier, monospace*/"><span style="margin-left:5px;color:#034f84">Medico que refiere:</span><br><span style="margin-left:5px"><?php echo $datos_antigenos[$i]["observaciones"].".";?></span></td>
...
<p style="font-family: Courier, monospace;font-size: 15px;margin-top:10px">Interpretación del resultado<br>  
...
El test NADAL COVID-19 Ag se evaluó con muestras clínicas cuyo estado se confirmó mediante RT-PCR. <br>
