  ...
  <div class="modal-dialog" id="tamModal_hemo">
    <div class="modal-content">
            ...
            <td><!--VARIOS OTROS-->
              ...
              <tr><td colspan="30" style="width: 30%;text-align: center;"><b>VARIOS</b></td></tr>
                ...
                <tr>
                  ...
                  <td colspan="15" style="width: 15%"><input type="text" class="form-control" id="ritro_hemato" style="text-align: right;"></td>
                </tr>
                <tr><td colspan="30" style="width: 30%;text-align: center;"><b>OTROS</b></td></tr>
                <tr>
                  <td colspan="30" style="width: 100%;">
                    <textarea id="otros_hema"  class="form-control" rows="11"></textarea>
                  </td>
                </tr>
              </table>
            </td><!--VARIOS OTROS-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary btn-block" onClick="GuardarHemograma();">Guardar</button>
      </div>
